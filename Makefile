...
OBJ_C = $(wildcard ${DIR_C_JSON}/*.c ${DIR_OUTPUT}/*.c ${DIR_CURRENT}/*.c ${DIR_I2C}/*.c ${DIR_MQTT}/*.c ${DIR_GPIO}/*.c ${DIR_SHT30}/*.c) ${TARGET}.c
OBJ_O = $(patsubst %.c,${DIR_BIN}/%.o,$(notdir ${OBJ_C}))

INCLUDES= -I$(DIR_C_JSON) -I$(DIR_OUTPUT) -I$(DIR_CURRENT) -I$(DIR_I2C) -I$(DIR_MQTT) -I$(DIR_GPIO) -I$(DIR_SHT30) -I.
